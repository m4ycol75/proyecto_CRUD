...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $actividadObj = new Agenda($conexion);
    $actividadObj->actualizarActividad($id,$nombre,$actividad,$descripcion,$fecha_inicio,$fecha_limite,$recordatorio,$estado);
        header("Location: inicio.php?msg=actualizado");
        exit();
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col-6">
                            ...
                            <input type="text" class="form-control" name="recordatorio" id="recordatorio" value="<?php echo $datosActividad['recordatorio']; ?>">
